...
public class CartLabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton  = findViewById(R.id.buttonCLADatePicker);
        timeButton = findViewById(R.id.buttonCLATimePicker);
        btnCheckout = findViewById(R.id.buttonCLACheckout);
        btnBack = findViewById(R.id.buttonCLABack);
